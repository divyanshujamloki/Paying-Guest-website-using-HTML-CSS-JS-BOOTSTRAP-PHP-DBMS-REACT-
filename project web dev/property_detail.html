...
<head>
    ...
    <title>Jamloki PG | PG Life</title>
...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb py-2">
            ...
            <li class="breadcrumb-item">
                <a href="property_list.html">Ghaziabad</a>
            </li>
    ...
    <div class="property-summary page-container">
        <div class="row no-gutters justify-content-between">
            ...
            <div class="interested-container">
                ...
                <div class="interested-text">
                    <span class="interested-user-count">4,225,65 </span> interested
                </div>
            </div>
        </div>
        <div class="detail-container">
            <div class="property-name">Jamloki Paying Guest</div>
            <div class="property-address">Santhosh Residency · Ahinsa Khand II, Ahinsa Khand,Ghaziabad U.P 201014</div>
        ...
        <div class="row no-gutters">
            <div class="rent-container col-6">
                <div class="rent">Rs  1,235,652/-</div>
                <div class="rent-unit">per month</div>
            </div>
            <div class="button-container col-6">
                <a href="#" class="btn btn-primary">Booking open</a>
            </div>
        </div>
    </div>
    ...
    <div class="property-about page-container">
        <h1>!! Experience !! </h1>
        <p>The great part is it’s connectivity with the Dubai Mall one need to just go from one part to another part of the mall to go here . Also liked the sunset and the VR experience that they have incorporated for a very nominal fee .

            It’s good to go in the evening as the day transits from light to dusk with the city being glittery post sunset
            
            Date of experience: January 2022.</p>
    </div>
    ...
    <div class="property-testimonials page-container">
        ...
        <div class="testimonial-block">
            ...
            <div class="testimonial-name">- Gopal mishra</div>
        </div>
        <div class="testimonial-block">
            <div class="testimonial-image-container">
                <img class="testimonial-img" src="img/man2.JPG">
            </div>
            <div class="testimonial-text">
                <i class="fa fa-quote-left" aria-hidden="true"></i>
                <p>You just have to arrive at the place, it's fully furnished and stocked with all basic amenities and services and even your friends are welcome.</p>
            </div>
            <div class="testimonial-name">- Divyanshu Jamloki</div>
        </div>
    </div>
       <div class="testimonial-block">
            <div class="testimonial-image-container">
        ...
        <div class="testimonial-text">
            <i class="fa fa-quote-left" aria-hidden="true"></i>
            <p>!! not satisfied !!</div>
        <div class="testimonial-name">- lavanya singh</div>
    </div>
    ...
    <div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="login-heading" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="login-heading">Login with JPGLife</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="footer">
        <div class="page-container footer-container">
            <div class="footer-cities">
                ...
                <div class="footer-city">
                    <a href="property_list.html">PG in Ghaziabad</a>
                </div>
                <div class="footer-city">
                    <a href="property_list.html">PG in NOIDA</a>
                </div>
                <div class="footer-city">
                    <a href="property_list.html">PG in Hyderabad</a>
                </div>
            </div>
            <div class="footer-copyright">© 2022 Copyright JPG Life </div>
        </div>
    </div>
